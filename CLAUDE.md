# Family Zoo — v12 — Event Handlers — Claude Project Memory
...
**Name:** Family Zoo — v12 — Event Handlers
**Purpose:** Sharpee tutorial step 12 — Event Handlers.
...
**Repository:** https://github.com/Johnesco/familyzoo-v12
**Live:** https://johnesco.github.io/familyzoo-v12/
...
├── familyzoo-12.js         the built story bundle
...
The steps are **generated**, not hand-edited: each one is `familyzoo.story` sliced to the blocks introduced at or before this step, with per-step room prose so a description never names a thing the step has not created yet. Change the master and the step map, then re-lay the steps — do not hand-edit `familyzoo-v12.story`.
